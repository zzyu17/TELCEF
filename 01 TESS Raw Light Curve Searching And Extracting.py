...
lc_collection_mission = lc_search_result[(np.char.find(lc_search_result.mission.astype(str), mission) >= 0)].download_all() ##### add extra filtering conditions to exclude specific authors if their light curves are not supported #####
